...
Контекст снят с экрана через OCR и может содержать опечатки, обрезки соседних фраз и лишние символы — игнорируй этот мусор, он не часть текста.

Задача: переведи слово "{word}" на русский именно в том значении, в котором оно употреблено в этом контексте (не самое частотное значение, а контекстное). Затем переведи весь контекст целиком на естественный русский язык.

Правила ответа (соблюдай строго):
- Ответ — ровно 4 строки в формате ниже, каждое поле с новой строки, названия полей в точности как написано.
- Никаких вступлений, комментариев, пустых строк, markdown-разметки, кавычек вокруг значений.
- Поля "Перевод", "Пояснение" и "Перевод контекста" пиши ТОЛЬКО русскими словами: не вставляй в них слово "{word}", его формы и любые другие слова на иностранном языке или латинице.
- Если слово распознано с опечаткой, переводи наиболее вероятное исходное слово.

Перевод: <перевод слова на русский, 1–3 слова, контекстное значение>
Часть речи: <часть речи по-русски, одним словом: существительное, глагол, прилагательное и т.п.>
Пояснение: <одно короткое предложение по-русски: что слово значит именно в этом контексте>
...
Шаг 1. Найди в этом тексте ТО ОДНО предложение, в котором употреблено слово "{word}", — без соседних предложений и обрезков. Если границы предложения повреждены OCR, возьми максимально осмысленный цельный фрагмент с этим словом. Дальше работай только с ним.
Шаг 2. Определи значение слова "{word}" именно в этом предложении (контекстное значение, а не самое частотное) и заполни карточку.

Правила ответа (соблюдай строго):
- Ответ — ровно 8 строк в формате ниже, каждое поле с новой строки, названия полей в точности как написано.
- Никаких вступлений, комментариев, пустых строк, markdown-разметки, кавычек вокруг значений.
- Поля "Перевод", "Пояснение", "Перевод контекста", "Перевод карточки" и "Подсказка" пиши ТОЛЬКО русскими словами: не вставляй в них слово "{word}", его формы и любые другие иностранные слова или слова на латинице.
- Поле "Предложение" — единственное, где текст остаётся на языке оригинала, дословно как в тексте.
- Если слово распознано с опечаткой, переводи наиболее вероятное исходное слово.

Перевод: <перевод слова на русский с учётом контекста, 1–3 слова>
Часть речи: <часть речи по-русски, одним словом: существительное, глагол, прилагательное и т.п.>
Пояснение: <одно короткое предложение по-русски: что слово значит именно в этом контексте>
Предложение: <только то предложение, где встречается слово "{word}", дословно как в тексте, без соседних предложений>
Перевод контекста: <перевод строки "Предложение" на естественный русский>
Перевод карточки: <самый короткий русский перевод слова для лицевой стороны карточки, без пояснений>
Подсказка: <в круглых скобках 1–4 русских слова, отличающих это значение от других значений слова, например: "(событие, встреча людей)" или "(подходить друг другу)">
Транскрипция: <международная фонетическая транскрипция слова "{word}" в квадратных скобках, например [ˈmiːtɪŋ]>
""";
